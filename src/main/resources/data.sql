insert into Customer (customer_id, firstname, lastname, address, zip_code, province, phone_number)
Values (1, 'Tom', 'Hank', '38 Moo 14', '10140', 'Bangkok', '09111111');

insert into Product(product_id, name,type_of_size, size,color ,price, amount)
